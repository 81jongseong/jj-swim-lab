/**
 * 🏊 SwimLab - 다양한 샘플 회원 데이터 생성
 * 
 * 다양한 레벨, 질환, CSS 데이터를 가진 회원들을 생성합니다.
 */
...
const SwimmingCenter = require('../server/dist/models/SwimmingCenter');
  ...
  // 마스터 회원들
  {
    ...
    studentInfo: {
      ...
      swimmingProfile: {
        ...
        mainStrokes: ['freestyle', 'backstroke', 'breaststroke', 'butterfly'],
        excludedStrokes: [],
        trainingDays: [1, 2, 3, 4, 5, 6, 0], // 일요일까지
        sessionsPerWeek: 6,
        sessionDuration: 120,
        currentGoal: '실력 향상',
        conditionIds: []
