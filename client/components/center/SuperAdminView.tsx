      ...
      <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">전체 수업:</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div className="space-y-4">
                  {superAdminData.userGrowth?.map((month: any, index: number) => (
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  {superAdminData.recentActivities?.map((activity: any, index: number) => (
                    <div key={index} className="flex justify-between items-center text-sm">
                      ...
                      <div className="text-right">
                        <div className="text-gray-600">{activity.center}</div>
        ...
        {activeTab === 'analytics' && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h4 className="font-semibold text-gray-900 mb-4">📊 센터별 성과</h4>
                <div className="space-y-4">
                  {superAdminData.centerStats?.map((center: any, index: number) => (
                    <div key={index} className="flex justify-between items-center">
                      <span className="text-gray-600">{center.name}</span>
                      <div className="text-right">
                        <div className="font-medium">₩{center.revenue?.toLocaleString()}</div>
                        <div className="text-sm text-gray-500">{center.users}명</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h4 className="font-semibold text-gray-900 mb-4">🎯 주요 지표</h4>
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-gray-600">전체 수업 완료율:</span>
        ...
        {activeTab === 'system' && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h4 className="font-semibold text-gray-900 mb-4">📋 시스템 정보</h4>
                <div className="space-y-4">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">2024년 6월</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">지원 종료:</span>
                    <span className="font-medium">2025년 12월</span>
                  </div>
                </div>
              </div>
            </div>
