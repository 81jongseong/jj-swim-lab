/**
 * 📝 JJ Swim Lab - 건강정보 관리 페이지 (권한별 접근)
 *
 * 📋 **페이지 목적**
 * - 사용자 권한별로 다른 건강정보 관리 기능 제공
 * - 학생: 개인 건강정보 입력/수정 및 공개/비공개 설정
 * - 강사/센터관리자: 소속 학생들의 건강정보 항목 조회
 * - 최고관리자: 전체 건강정보 시스템 설정 및 관리
 * - AI 기반 맞춤형 운동 추천 및 건강 상태 분석
 * - 권한별 차등화된 정보 표시 및 접근 제어
 *
 * 🔄 **주요 기능**
