        ...
        <div className="container mx-auto px-6">
          ...
          >
            <motion.h2
              ...
              className="text-4xl md:text-5xl font-bold text-foreground mb-6"
            >
              <span className="bg-gradient-text">🏊‍♂️ JJ Swim Lab</span>
            </motion.h2>
            <motion.p
              variants={motionPresets.slideUp}
              className="text-xl text-muted-foreground max-w-3xl mx-auto"
            >
              전문 수영 교육과 최첨단 AI 기술이 만나는 프리미엄 수영 센터
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="h-96 rounded-3xl overflow-hidden shadow-deep bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center">
                <div className="text-center text-blue-600">
                  <div className="text-8xl mb-4">🏊‍♂️</div>
                  <h3 className="text-2xl font-bold mb-2">JJ Swim Lab</h3>
                  <p className="text-lg opacity-80">프리미엄 수영 교육 센터</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                  ...
                  <h4 className="font-semibold text-gray-900 mb-1">전문 인증</h4>
                  <p className="text-sm text-gray-600">국제 수영 인증 기관</p>
                </div>
                <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                  <div className="text-2xl mb-2">🤖</div>
                  <h4 className="font-semibold text-gray-900 mb-1">AI 분석</h4>
                  <p className="text-sm text-gray-600">실시간 자세 분석</p>
                </div>
                <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                  <div className="text-2xl mb-2">👨‍🏫</div>
                  <h4 className="font-semibold text-gray-900 mb-1">전문 강사</h4>
                  <p className="text-sm text-gray-600">경험 풍부한 강사진</p>
                </div>
                <div className="bg-white p-4 rounded-xl shadow-sm border border-blue-100">
                  <div className="text-2xl mb-2">💧</div>
                  <h4 className="font-semibold text-gray-900 mb-1">청결한 시설</h4>
                  <p className="text-sm text-gray-600">최신 정수 시스템</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className="text-2xl font-bold text-foreground">JJ Swim Lab을 선택하는 이유</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">AI 기반 개인 맞춤 교육</h4>
                    <p className="text-gray-600 text-sm">
                      최첨단 AI 기술로 개인의 수영 실력을 분석하고 맞춤형 강습법을 제공합니다.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">전문가 강사진</h4>
                    <p className="text-gray-600 text-sm">
                      국제 수영 인증을 받은 경험 풍부한 강사들이 체계적인 교육을 제공합니다.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">최신 시설과 장비</h4>
                    <p className="text-gray-600 text-sm">
                      정수 시스템과 최신 수영 장비로 안전하고 쾌적한 수영 환경을 제공합니다.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">체계적인 진도 관리</h4>
                    <p className="text-gray-600 text-sm">
                      개인의 수영 실력 향상을 체계적으로 추적하고 관리하여 목표 달성을 도와드립니다.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
                <h4 className="font-semibold text-blue-900 mb-2">📞 센터 정보</h4>
                <div className="space-y-2 text-sm text-blue-800">
                  <p><strong>위치:</strong> 서울시 강남구 테헤란로 123</p>
                  <p><strong>운영시간:</strong> 평일 06:00-22:00, 주말 08:00-20:00</p>
                  <p><strong>전화:</strong> 02-1234-5678</p>
                  <p><strong>이메일:</strong> info@jjswim.com</p>
                </div>
              </div>
              ...
              <div className="flex space-x-4">
                <a
                  href="/center-info"
                  className="flex-1 px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors duration-300 text-center"
                >
                  센터 자세히 보기
                </a>
                <a
                  href="/booking"
                  className="flex-1 px-6 py-3 border-2 border-blue-600 text-blue-600 font-semibold rounded-xl hover:bg-blue-600 hover:text-white transition-colors duration-300 text-center"
                >
                  체험 예약하기
                </a>
              </div>
