...
exports.allJointConditions = exports.EVIDENCE_BASED_SOURCES = void 0;
exports.EVIDENCE_BASED_SOURCES = {
...
exports.allJointConditions = [
    {
        ...
        severity: 'moderate',
        swimmingGuidance: {
            freestyle: { ...strokeTemplates.spine.freestyle, medicalEvidence: [exports.EVIDENCE_BASED_SOURCES.HAYDEN_2005_COCHRANE] },
            backstroke: { ...strokeTemplates.spine.backstroke, medicalEvidence: [exports.EVIDENCE_BASED_SOURCES.HAYDEN_2005_COCHRANE] },
            breaststroke: { ...strokeTemplates.spine.breaststroke, medicalEvidence: [exports.EVIDENCE_BASED_SOURCES.HAYDEN_2005_COCHRANE] },
            butterfly: { ...strokeTemplates.spine.butterfly, medicalEvidence: [exports.EVIDENCE_BASED_SOURCES.HAYDEN_2005_COCHRANE] },
            elementary_backstroke: { ...strokeTemplates.spine.elementary_backstroke, medicalEvidence: [exports.EVIDENCE_BASED_SOURCES.HAYDEN_2005_COCHRANE] },
            sidestroke: { ...strokeTemplates.spine.sidestroke, medicalEvidence: [exports.EVIDENCE_BASED_SOURCES.HAYDEN_2005_COCHRANE] }
        },
