 ...
 */
// 의학적 근거 소스
export const SPECIAL_CONDITIONS_EVIDENCE = {
...
// 특수 상황별 가이드라인 데이터
export const specialConditionsData = [
    // 임신부 수영 가이드라인
    {
...
export function generateSpecialConditionPlan(condition, stage, baseHealthData) {
    const conditionData = specialConditionsData.find(data => data.conditionId.includes(condition) &&
...
//# sourceMappingURL=special-conditions.js.map