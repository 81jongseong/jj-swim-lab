/**
 * 🏊‍♂️ JJ Swim Lab - 관절질환별 운동 가이드라인 데이터 (검증된 출처 반영 버전)
 * 
 * 📋 데이터 목적
...
export interface StrokeGuidance {
  ...
  alternatives: Stroke[];
  medicalEvidence: MedicalCitation[]; // stroke별 직접근거가 부족하므로 보통 condition 근거를 재사용
...
export const EVIDENCE_BASED_SOURCES: Record<string, MedicalCitation> = {
  ...
  JOSPT_2022_LATERAL_ELBOW_CPG: {
    id: 'JOSPT_2022_LATERAL_ELBOW_CPG',
    citation: 'Lucado AM et al. Lateral Elbow Pain & Muscle Function Impairments—CPG. JOSPT. 2022;52(12):CPG1-CPG44.',
    link: 'https://doi.org/10.2519/jospt.2022.0302',
    level: 'CPG',
    keyFindings: '외측 상과 건병증에 대한 종합적인 임상진료지침.'
  },
  J_HAND_THER_2021_TENNIS_ELBOW_SR: {
    id: 'J_HAND_THER_2021_TENNIS_ELBOW_SR',
    citation: 'Cullinane FL et al. Exercise therapy for lateral elbow pain: A systematic review. J Hand Ther. 2021;34(2):151-160.',
    link: 'https://doi.org/10.1016/j.jht.2020.01.001',
    level: 'SR/MA',
    keyFindings: '테니스 엘보우에 대한 운동치료의 체계적 문헌고찰.'
  },
...
// 기관 레벨 정보(참고)
export const MEDICAL_SOURCES_INFO = {
  KOREAN_ORTHOPAEDIC: {
    name: '대한정형외과학회',
    description: '한국의 정형외과 전문의들이 모인 공식 학회',
    website: 'https://www.koa.or.kr',
    reliability: '높음 - 공식 의학 학회'
  },
  KOREAN_RHEUMATOLOGY: {
    name: '대한류마티스학회',
    description: '한국의 류마티스 전문의들이 모인 공식 학회',
    website: 'https://www.rheum.or.kr',
    reliability: '높음 - 공식 의학 학회'
  },
  NIH_EXERCISE: {
    name: '미국 국립보건원',
    description: '미국 정부의 공식 의학 연구 기관',
    website: 'https://www.nih.gov',
    reliability: '매우 높음 - 정부 공식 기관'
  },
  MAYO_CLINIC: {
    name: '메이요 클리닉',
    description: '국제적 의료 기관',
    website: 'https://www.mayoclinic.org',
    reliability: '매우 높음 - 국제적 의료 기관'
  },
  WHO_PHYSICAL_ACTIVITY: {
    name: '세계보건기구',
    description: 'UN 산하 국제 보건 기구',
    website: 'https://www.who.int',
    reliability: '매우 높음 - 국제 기구'
  },
  ACSM_GUIDELINES: {
    name: '미국운동의학회',
    description: '운동 의학 분야의 권위 있는 학회',
    website: 'https://www.acsm.org',
    reliability: '높음 - 전문 학회'
  }
} as const;
...
const categoryEvidence: Record<Category, string[]> = {
  ...
  elbow: ['JOSPT_2022_LATERAL_ELBOW_CPG', 'J_HAND_THER_2021_TENNIS_ELBOW_SR'], // 팔꿈치 전용 근거
