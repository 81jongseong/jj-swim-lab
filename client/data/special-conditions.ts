...
export const specialConditionsData: SpecialConditionGuidance[] = [
  ...
  // 심장 수술 후 재활
  {
    conditionId: 'post_cardiac_surgery_acute',
    conditionName: '심장 수술 후 급성기 (0-8주)',
    category: 'post_cardiac_surgery',
    severity: 'severe',
    swimmingGuidance: {
      freestyle: {
        level: 'avoid',
        reason: '심장 수술 후 급성기에는 심부하가 큰 영법 금지',
        allowedMovements: [],
        prohibitedMovements: ['강한 팔 동작', '심부하 증가', '급격한 움직임'],
        modifications: ['수술 후 급성기 완전 금지'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_CARDIAC_SURGERY_AQUATIC_2018],
        detailedExplanation: '심장 수술 후 급성기에는 심부하가 큰 영법은 금지'
      },
      backstroke: {
        level: 'caution',
        reason: '심장 수술 후 급성기에는 주의 필요',
        allowedMovements: ['매우 부드러운 팔 동작'],
        prohibitedMovements: ['강한 팔 동작', '심부하 증가'],
        modifications: ['매우 부드러운 동작', '짧은 시간'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_CARDIAC_SURGERY_AQUATIC_2018],
        detailedExplanation: '심장 수술 후 급성기에는 매우 부드러운 동작만 허용'
      },
      breaststroke: {
        level: 'avoid',
        reason: '심장 수술 후 급성기에는 심부하가 큰 영법 금지',
        allowedMovements: [],
        prohibitedMovements: ['킥 동작', '심부하 증가', '팔 동작'],
        modifications: ['수술 후 급성기 완전 금지'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_CARDIAC_SURGERY_AQUATIC_2018],
        detailedExplanation: '심장 수술 후 급성기에는 심부하가 큰 영법은 금지'
      ...
      butterfly: {
        ...
        reason: '심장 수술 후 급성기에는 심부하가 큰 영법 금지',
        allowedMovements: [],
        prohibitedMovements: ['돌핀 킥', '강한 팔 동작', '심부하 증가'],
        modifications: ['수술 후 급성기 완전 금지'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_CARDIAC_SURGERY_AQUATIC_2018],
        detailedExplanation: '심장 수술 후 급성기에는 심부하가 큰 영법은 금지'
      ...
      elementary_backstroke: {
        level: 'safe',
        reason: '심장 수술 후 급성기에 가장 안전한 영법',
        allowedMovements: ['매우 부드러운 팔 동작', '부드러운 킥 동작'],
        prohibitedMovements: ['강한 동작', '심부하 증가'],
        modifications: ['매우 부드러운 동작', '짧은 시간'],
        alternatives: ['backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_CARDIAC_SURGERY_AQUATIC_2018],
        detailedExplanation: '기본배영은 심장 수술 후 급성기에 가장 안전한 영법'
      },
      sidestroke: {
        level: 'avoid',
        reason: '심장 수술 후 급성기에는 심부하가 큰 영법 금지',
    ...
    exerciseRestrictions: {
      ...
      durationLimit: 15,
      frequencyLimit: 2,
      contraindicatedExercises: ['모든 고강도 운동', '심부하가 큰 영법'],
      recommendedExercises: ['기본배영', '부드러운 배영']
    },
    medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_CARDIAC_SURGERY_AQUATIC_2018],
    specialConsiderations: [
      '심장 수술 후 급성기에는 매우 제한적인 운동만 허용',
      '의료진 승인 후 운동 시작',
      '심부하 모니터링 필수',
      '점진적인 회복을 위한 단계적 접근'
    ]
  ...
  // 척추 수술 후 재활
  {
    conditionId: 'post_spinal_surgery_acute',
    conditionName: '척추 수술 후 급성기 (0-12주)',
    category: 'post_spinal_surgery',
    severity: 'severe',
    swimmingGuidance: {
      freestyle: {
        level: 'avoid',
        reason: '척추 수술 후 급성기에는 척추 부담이 큰 영법 금지',
        allowedMovements: [],
        prohibitedMovements: ['강한 팔 동작', '척추 회전', '급격한 움직임'],
        modifications: ['수술 후 급성기 완전 금지'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_JOINT_SURGERY_REHAB_AAOS_2021],
        detailedExplanation: '척추 수술 후 급성기에는 척추 부담이 큰 영법은 금지'
      },
      backstroke: {
        level: 'caution',
        reason: '척추 수술 후 급성기에는 주의 필요',
        allowedMovements: ['매우 부드러운 팔 동작'],
        prohibitedMovements: ['강한 팔 동작', '척추 회전'],
        modifications: ['매우 부드러운 동작', '짧은 시간'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_JOINT_SURGERY_REHAB_AAOS_2021],
        detailedExplanation: '척추 수술 후 급성기에는 매우 부드러운 동작만 허용'
      },
      breaststroke: {
        level: 'avoid',
        reason: '척추 수술 후 급성기에는 척추 부담이 큰 영법 금지',
        allowedMovements: [],
        prohibitedMovements: ['킥 동작', '척추 회전', '팔 동작'],
        modifications: ['수술 후 급성기 완전 금지'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_JOINT_SURGERY_REHAB_AAOS_2021],
        detailedExplanation: '척추 수술 후 급성기에는 척추 부담이 큰 영법은 금지'
      ...
      butterfly: {
        ...
        reason: '척추 수술 후 급성기에는 척추 부담이 큰 영법 금지',
        allowedMovements: [],
        prohibitedMovements: ['돌핀 킥', '강한 팔 동작', '척추 회전'],
        modifications: ['수술 후 급성기 완전 금지'],
        alternatives: ['elementary_backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_JOINT_SURGERY_REHAB_AAOS_2021],
        detailedExplanation: '척추 수술 후 급성기에는 척추 부담이 큰 영법은 금지'
      ...
      elementary_backstroke: {
        level: 'safe',
        reason: '척추 수술 후 급성기에 가장 안전한 영법',
        allowedMovements: ['매우 부드러운 팔 동작', '부드러운 킥 동작'],
        prohibitedMovements: ['강한 동작', '척추 회전'],
        modifications: ['매우 부드러운 동작', '짧은 시간'],
        alternatives: ['backstroke'],
        medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_JOINT_SURGERY_REHAB_AAOS_2021],
        detailedExplanation: '기본배영은 척추 수술 후 급성기에 가장 안전한 영법'
      },
      sidestroke: {
        level: 'avoid',
        reason: '척추 수술 후 급성기에는 척추 부담이 큰 영법 금지',
    ...
    exerciseRestrictions: {
      intensityReduction: 70,
      durationLimit: 15,
      frequencyLimit: 2,
      contraindicatedExercises: ['모든 고강도 운동', '척추 부담이 큰 영법'],
      recommendedExercises: ['기본배영', '부드러운 배영']
    },
    medicalEvidence: [SPECIAL_CONDITIONS_EVIDENCE.POST_JOINT_SURGERY_REHAB_AAOS_2021],
    specialConsiderations: [
      '척추 수술 후 급성기에는 매우 제한적인 운동만 허용',
      '의료진 승인 후 운동 시작',
      '척추 안정성 유지 필수',
      '점진적인 회복을 위한 단계적 접근'
    ]
