...
console.log('🧪 JJ Swim Lab CI 테스트 시작...\n');
...
function runTests() {
  try {
    ...
    console.log('📊 6단계: 성능 테스트');
    execSync('npm run performance', { stdio: 'inherit' });
    console.log('✅ 성능 테스트 완료\n');

    console.log('🎉 모든 CI 테스트가 성공적으로 완료되었습니다!');
    
    // 성공 상태로 종료
    process.exit(0);
    
  } catch (error) {
    console.error('❌ CI 테스트 실패:', error.message);
