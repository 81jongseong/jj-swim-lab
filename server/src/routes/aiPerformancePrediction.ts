...
router.get('/:predictionId/needs-update', authMiddleware, async (req, res) => {
  try {
    ...
    logError('업데이트 필요 여부 확인 오류:', error);
    res.status(500).json({ 
