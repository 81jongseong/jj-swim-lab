...
async function testCourseCreationWithInstructor() {
  try {
    ...
    // 강습 과정 생성 데이터
    const courseData = {
      name: '강사 배정 테스트 강습 과정',
      description: '강사 배정이 제대로 되는지 테스트하는 강습 과정입니다.',
      level: 'beginner',
      duration: 60,
      price: 50000,
      maxStudents: 10,
...
testCourseCreationWithInstructor();
