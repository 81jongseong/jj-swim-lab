...
const job_board_1 = __importDefault(require("./routes/job-board"));
...
const instructor_progress_1 = __importDefault(require("./routes/instructor-progress"));
const ai_routine_recommendations_1 = __importDefault(require("./routes/ai-routine-recommendations"));
const quiz_question_generator_1 = __importDefault(require("./routes/quiz-question-generator"));
...
app.use('/api/quiz-question-generator', quiz_question_generator_1.default);
...
app.use('/api/checklists', checklist_1.default);
...
app.use('/api/center-level', center_level_1.default);
...
app.use('/api/center-admin-instructor-stats', center_admin_instructor_stats_1.default);
...
app.use('/api/job-board', job_board_1.default);
