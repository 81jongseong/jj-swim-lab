...
class NotificationService {
    static async createLearningProgressNotification(userId, progressData) {
        try {
    ...
    static async createLessonPlanNotification(instructorId, studentId, lessonData) {
        try {
    ...
    static async createQuizNotification(userId, quizData) {
        try {
