...
exports.MedicalExercisePrescriptionService = void 0;
const HealthAssessment_1 = require("../models/HealthAssessment");
class MedicalExercisePrescriptionService {
    static async createMedicalPrescription(request) {
        try {
            const healthAssessment = await HealthAssessment_1.HealthAssessment.findById(request.healthAssessmentId)
            ...
            const conditionGuidelines = this.getConditionSpecificGuidelines(healthAssessment.chronicConditions);
            const exerciseRecommendations = this.generateExerciseRecommendations(healthAssessment, request, riskAnalysis, conditionGuidelines);
            const safetyGuidelines = this.generateSafetyGuidelines(healthAssessment, riskAnalysis);
            const progressionPlan = this.createProgressionPlan(healthAssessment, exerciseRecommendations);
            const medicalSupervision = this.determineMedicalSupervision(healthAssessment, riskAnalysis);
            const contraindications = this.identifyContraindications(healthAssessment);
            ...
            return {
                ...
                patientInfo: {
                    ...
                    currentMedications: healthAssessment.chronicConditions.flatMap(c => c.medications.map(m => m.name))
                },
    ...
    static analyzeHealthRisks(healthAssessment) {
        const latestVitals = healthAssessment.getLatestVitalSigns();
        const riskFactors = [];
        ...
        return {
            ...
            overallRisk,
            riskFactors,
            requiresSupervision: overallRisk === HealthAssessment_1.HealthRiskLevel.HIGH ||
    ...
    static getConditionSpecificGuidelines(chronicConditions) {
        const guidelines = {
            [HealthAssessment_1.ChronicCondition.HYPERTENSION]: {
                recommendedTypes: [HealthAssessment_1.ExerciseRecommendationType.AEROBIC_MODERATE, HealthAssessment_1.ExerciseRecommendationType.RESISTANCE_LIGHT],
                intensityRange: [3, 6],
                durationRange: [20, 45],
                frequencyRange: [3, 5],
            ...
            [HealthAssessment_1.ChronicCondition.DIABETES_TYPE2]: {
                recommendedTypes: [HealthAssessment_1.ExerciseRecommendationType.AEROBIC_MODERATE, HealthAssessment_1.ExerciseRecommendationType.RESISTANCE_LIGHT, HealthAssessment_1.ExerciseRecommendationType.FLEXIBILITY],
                intensityRange: [4, 7],
                durationRange: [30, 60],
                frequencyRange: [4, 6],
            ...
            [HealthAssessment_1.ChronicCondition.HEART_DISEASE]: {
                recommendedTypes: [HealthAssessment_1.ExerciseRecommendationType.AEROBIC_LOW, HealthAssessment_1.ExerciseRecommendationType.FLEXIBILITY],
                intensityRange: [2, 5],
                durationRange: [15, 30],
                frequencyRange: [3, 4],
            ...
            [HealthAssessment_1.ChronicCondition.ASTHMA]: {
                recommendedTypes: [HealthAssessment_1.ExerciseRecommendationType.AEROBIC_LOW, HealthAssessment_1.ExerciseRecommendationType.FLEXIBILITY, HealthAssessment_1.ExerciseRecommendationType.BREATHING],
                intensityRange: [3, 6],
                durationRange: [20, 40],
                frequencyRange: [3, 5],
                targetHR: { min: 0.4, max: 0.7 },
            ...
            [HealthAssessment_1.ChronicCondition.ARTHRITIS]: {
                recommendedTypes: [HealthAssessment_1.ExerciseRecommendationType.FLEXIBILITY, HealthAssessment_1.ExerciseRecommendationType.AEROBIC_LOW, HealthAssessment_1.ExerciseRecommendationType.BALANCE],
                intensityRange: [2, 5],
                durationRange: [20, 45],
                frequencyRange: [4, 6],
                targetHR: { min: 0.3, max: 0.6 },
            ...
            [HealthAssessment_1.ChronicCondition.OSTEOPOROSIS]: {
                recommendedTypes: [HealthAssessment_1.ExerciseRecommendationType.RESISTANCE_LIGHT, HealthAssessment_1.ExerciseRecommendationType.BALANCE, HealthAssessment_1.ExerciseRecommendationType.FLEXIBILITY],
                intensityRange: [3, 6],
                durationRange: [30, 45],
                frequencyRange: [3, 4],
                targetHR: { min: 0.4, max: 0.7 },
    ...
    static generateExerciseRecommendations(healthAssessment, request, riskAnalysis, conditionGuidelines) {
        const recommendations = [];
        const latestVitals = healthAssessment.getLatestVitalSigns();
        const baseParams = this.calculateBaseParameters(healthAssessment, riskAnalysis, conditionGuidelines);
        const targetHR = this.calculateTargetHeartRate(healthAssessment.basicHealth.age, latestVitals?.restingHR || 70, baseParams.intensityRange);
        if (baseParams.includeAerobic) {
            recommendations.push({
                type: riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.HIGH ||
                    riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.VERY_HIGH ?
                    HealthAssessment_1.ExerciseRecommendationType.AEROBIC_LOW :
                    HealthAssessment_1.ExerciseRecommendationType.AEROBIC_MODERATE,
                intensity: baseParams.aerobicIntensity,
                duration: baseParams.aerobicDuration,
                frequency: baseParams.aerobicFrequency,
                targetHR,
                specificExercises: this.generateAerobicExercises(healthAssessment, request.environmentalFactors, baseParams.aerobicIntensity),
        ...
        if (baseParams.includeResistance) {
            recommendations.push({
                type: HealthAssessment_1.ExerciseRecommendationType.RESISTANCE_LIGHT,
                ...
                specificExercises: this.generateResistanceExercises(healthAssessment, request.environmentalFactors, baseParams.resistanceIntensity),
        ...
        recommendations.push({
            type: HealthAssessment_1.ExerciseRecommendationType.FLEXIBILITY,
            intensity: 3,
            duration: 15,
            frequency: 6,
            targetHR: {
        ...
        if (healthAssessment.basicHealth.age >= 65 ||
            healthAssessment.chronicConditions.some(c => c.condition === HealthAssessment_1.ChronicCondition.OSTEOPOROSIS)) {
            recommendations.push({
                type: HealthAssessment_1.ExerciseRecommendationType.BALANCE,
                intensity: 3,
                duration: 10,
                frequency: 3,
                targetHR: {
    ...
    static calculateBaseParameters(healthAssessment, riskAnalysis, conditionGuidelines) {
        ...
        if (healthAssessment.basicHealth.bmi >= 30) {
            aerobicDuration = Math.min(aerobicDuration, 25);
        }
        return {
            aerobicIntensity,
            aerobicDuration,
            ...
            includeAerobic: true,
            includeResistance: riskAnalysis.overallRisk !== HealthAssessment_1.HealthRiskLevel.CRITICAL
        };
    }
    static calculateTargetHeartRate(age, restingHR, intensityRange) {
        const maxHR = 220 - age;
        const heartRateReserve = maxHR - restingHR;
        const minIntensity = intensityRange[0] / 10;
    ...
    static generateAerobicExercises(healthAssessment, environmentalFactors, intensity) {
        const exercises = [];
        ...
        if (intensity >= 5 && healthAssessment.riskAssessment.overallRisk !== HealthAssessment_1.HealthRiskLevel.HIGH) {
            exercises.push({
                name: '가벼운 조깅',
                duration: 15,
                modifications: [
    ...
    static generateResistanceExercises(healthAssessment, environmentalFactors, intensity) {
        const exercises = [];
        exercises.push({
            name: '의자에서 일어서기',
            sets: 2,
    ...
    static generateBalanceExercises() {
        return [
            {
                name: '한 발로 서기',
                duration: 1,
    ...
    static getAerobicPrecautions(healthAssessment, riskAnalysis) {
    ...
    static getAerobicContraindications(healthAssessment) {
        const contraindications = [];
        if (healthAssessment.riskAssessment.overallRisk === HealthAssessment_1.HealthRiskLevel.CRITICAL) {
    ...
    static determineMedicalSupervision(healthAssessment, riskAnalysis) {
        const highRiskConditions = [
            HealthAssessment_1.ChronicCondition.HEART_DISEASE,
            HealthAssessment_1.ChronicCondition.DIABETES_TYPE1,
            HealthAssessment_1.ChronicCondition.KIDNEY_DISEASE
        ];
        const hasHighRiskCondition = healthAssessment.chronicConditions.some(c => highRiskConditions.includes(c.condition));
        return {
            required: riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.HIGH ||
                riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.VERY_HIGH ||
                riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.CRITICAL ||
                hasHighRiskCondition,
            frequency: riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.CRITICAL ? '매 운동시' :
                riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.VERY_HIGH ? '주 2회' :
                    riskAnalysis.overallRisk === HealthAssessment_1.HealthRiskLevel.HIGH ? '주 1회' : '월 1회',
            specialistReferral: hasHighRiskCondition,
            clearanceNeeded: healthAssessment.riskAssessment.clearanceRequired
        };
    }
    static identifyContraindications(healthAssessment) {
        const absolute = [];
        const relative = [];
        if (healthAssessment.riskAssessment.overallRisk === HealthAssessment_1.HealthRiskLevel.CRITICAL) {
            absolute.push('의료진 승인 없이 운동 금지');
        }
        if (healthAssessment.chronicConditions.some(c => c.condition === HealthAssessment_1.ChronicCondition.HYPERTENSION)) {
            relative.push('혈압 180/110 이상시 운동 연기');
        }
        return { absolute, relative };
    }
    static async checkExerciseClearance(healthAssessmentId) {
        try {
            const assessment = await HealthAssessment_1.HealthAssessment.findById(healthAssessmentId);
            if (!assessment) {
                throw new Error('건강 평가를 찾을 수 없습니다.');
            }
            const latestVitals = assessment.getLatestVitalSigns();
            const recommendations = [];
            ...
            const diabeticCondition = assessment.chronicConditions.find(c => c.condition === HealthAssessment_1.ChronicCondition.DIABETES_TYPE1 || c.condition === HealthAssessment_1.ChronicCondition.DIABETES_TYPE2);
            ...
            if (assessment.riskAssessment.overallRisk === HealthAssessment_1.HealthRiskLevel.HIGH) {
    ...
    static async getUserHealthAssessments(userId) {
        try {
            return await HealthAssessment_1.HealthAssessment.find({ userId, isActive: true })
    ...
    static async getHighRiskPatients() {
        try {
            return await HealthAssessment_1.HealthAssessment.getHighRiskPatients();
        }
        catch (error) {
    ...
    static async getPendingClearances() {
        try {
            return await HealthAssessment_1.HealthAssessment.getPendingClearances();
        }
        catch (error) {
...
exports.MedicalExercisePrescriptionService = MedicalExercisePrescriptionService;
exports.default = MedicalExercisePrescriptionService;
//# sourceMappingURL=medicalExercisePrescriptionService.js.map